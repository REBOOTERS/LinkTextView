...
class ExampleActivity : AppCompatActivity() {
    ...
    private lateinit var viewBinding: ActivityExampleBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        viewBinding = ActivityExampleBinding.inflate(layoutInflater)
        ...
        Linker.Builder()
            .content(android)
            .textView(viewBinding.textView1)
            .links(androidRules)
        ...
        Linker.Builder()
            .content(star)
            .textView(viewBinding.textView2)
            .links(starRules)
            .bold(true)
            .linkColor(ContextCompat.getColor(this, R.color.link))
            .addOnLinkClickListener(onLinkClickListener)
        ...
        Linker.Builder()
            .content(english)
            .textView(viewBinding.textView3)
            .links(englishRules)
        ...
        Linker.Builder()
            .content(actors)
            .textView(viewBinding.textView4)
            .links(actorsRules)
            .linkColor(ContextCompat.getColor(this, R.color.link))
        ...
        Linker.Builder()
            .content(actors)
            .textView(viewBinding.textView41)
        ...
        Linker.Builder()
            .content(email)
            .textView(viewBinding.textView5)
            .links(emailRules)
        ...
        Linker.Builder()
            .content(email)
            .textView(viewBinding.textView6)
            .links(emailRules)
